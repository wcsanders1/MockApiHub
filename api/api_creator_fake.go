...
func (c *fakeAPICreator) getHandler(enforceValidJSON, allowCORS bool, statusCode int, headers []config.Header, dir, fileName string, file wrapper.IFileOps) func(w http.ResponseWriter, r *http.Request) {
